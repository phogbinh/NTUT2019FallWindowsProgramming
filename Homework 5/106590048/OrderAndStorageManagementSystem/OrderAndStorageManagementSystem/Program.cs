...
namespace OrderAndStorageManagementSystem
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            MainForm mainForm = new MainForm(creditCardPaymentForm, new MainPresentationModel(), orderPresentationModel, new ProductManagementPresentationModel(model), model);
