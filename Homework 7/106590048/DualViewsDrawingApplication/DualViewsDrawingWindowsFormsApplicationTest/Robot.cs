...
namespace DualViewsDrawingWindowsFormsApplicationTest
{
    public class Robot
    {
        ...
        /// <summary>
        /// Selects the file by open file dialog.
        /// </summary>
        /// <param name="formName">Name of the form.</param>
        ...
        /// <summary>
        /// Asserts the other form button enable.
        /// </summary>
        /// <param name="formName">Name of the form.</param>
        /// <param name="buttonName">Name of the button.</param>
        /// <param name="assertValue">if set to <c>true</c> [assert value].</param>
        ...
        /// <summary>
        /// Sends the key enter to message box.
        /// </summary>
